//Commented out code parts are for using with an Array instead of an arrayList
...
void mousePressed(){
  ...
  manyRipples.add(new Ripple(mouseX,mouseY,2,50));
  
  //manyRipples[rippleNumber] ipple(mouseX,mouseY,2.2,100);
  //rippleNumber++;  
